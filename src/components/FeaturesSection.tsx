...
import { ArrowRightLeft, Shield, Droplets, Users, ArrowRight } from 'lucide-react';
...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section id="features" className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-16 bg-gradient-to-br from-[#0F0F1A] via-[#1A1A2E] to-[#0F0F1A]">
      <div className="max-w-7xl mx-auto w-full">
        {/* Features Header */}
        <div className="text-center mb-16">
          <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 font-orbitron">
          ...
          <p className="text-xl sm:text-2xl text-[#E0E0E0] mb-4 font-orbitron font-light">
            Smart Tools for Rise Chain
          </p>
          
          <p className="text-lg text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed font-orbitron">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                {/* Title */}
                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text transition-all duration-500 font-orbitron"
                    style={{ backgroundImage: `linear-gradient(to right, ${feature.accentColor}, #FF00FF)` }}>
                  {feature.title}
                </h3>

                {/* Description */}
                <p className="text-gray-300 text-base leading-relaxed mb-6 font-orbitron group-hover:text-gray-200 transition-colors duration-300">
                  {feature.description}
                </p>
                
                {/* Action indicator */}
                <div className="flex items-center text-sm font-semibold transition-all duration-300 group-hover:translate-x-2 font-orbitron uppercase tracking-wide"
