...
import { defaultConfig } from './ConcurrencyLimitConfig.js';
import { FaucetError } from '../../common/FaucetError.js';
import { SessionManager } from "../../session/SessionManager.js";
export class ConcurrencyLimitModule extends BaseModule {
    moduleDefaultConfig = defaultConfig;
    startModule() {
        this.moduleManager.addActionHook(this, ModuleHookAction.SessionStart, 7, "Recurring limits check", (session) => this.processSessionStart(session));
        this.moduleManager.addActionHook(this, ModuleHookAction.SessionIpChange, 6, "Recurring limits check", (session) => this.processSessionStart(session));
    ...
    checkLimit(session) {
        ...
        let concurrentLimitMessage = null;
        ...
        if (concurrentSessionCount >= this.moduleConfig.concurrencyLimit) {
            throw new FaucetError("CONCURRENCY_LIMIT", concurrentLimitMessage);
        }
    }
}
//# sourceMappingURL=ConcurrencyLimitModule.js.map