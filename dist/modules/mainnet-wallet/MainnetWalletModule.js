...
import { defaultConfig } from './MainnetWalletConfig.js';
import { FaucetError } from '../../common/FaucetError.js';
import { Erc20Abi } from '../../abi/ERC20.js';
export class MainnetWalletModule extends BaseModule {
    moduleDefaultConfig = defaultConfig;
    web3;
    startModule() {
        this.startWeb3();
        this.moduleManager.addActionHook(this, ModuleHookAction.SessionStart, 7, "Mainnet Wallet check", (session, userInput) => this.processSessionStart(session, userInput));
...
//# sourceMappingURL=MainnetWalletModule.js.map