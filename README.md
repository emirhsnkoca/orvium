# Rise Chain PoW Faucet
<img src="https://faucets.pk910.de/images/logo-cat-small.png" height="90px" />

[![GitHub release (latest by date)](https://img.shields.io/github/v/release/cemayyildiz/RiseChainFaucet?label=Latest%20Release)](https://github.com/cemayyildiz/RiseChainFaucet/releases/latest)

Modularized faucet for Rise Chain with different protection methods (Captcha, Mining, IP, Mainnet Balance, Gitcoin Passport and more)
